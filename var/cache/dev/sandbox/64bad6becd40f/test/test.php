...
require_once _PS_MODULE_DIR_ . 'test/classes/CustomText.php';
class Ps_CustomtextNew extends Module implements WidgetInterface
{
    ...
    public function __construct()
    {
        ...
        $this->templateFile = 'module:test/test.tpl';
    }
    ...
    public function installDB()
    {
        $return = Db::getInstance()->execute('
                CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'info_new` (
        ...
        $return = $return && Db::getInstance()->execute('
                CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'info_shop_new` (
        ...
        $return = $return && Db::getInstance()->execute('
                CREATE TABLE IF NOT EXISTS `' . _DB_PREFIX_ . 'info_lang_new` (
    ...
    public function uninstallDB($drop_table = true)
    {
        ...
        return Db::getInstance()->execute('DROP TABLE IF EXISTS `' . _DB_PREFIX_ . 'info_new`, `' . _DB_PREFIX_ . 'info_shop_new`, `' . _DB_PREFIX_ . 'info_lang_new`');
    }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('test'))) {
            $this->smarty->assign($this->getWidgetVariables($hookName, $configuration));
        }

        return $this->fetch($this->templateFile, $this->getCacheId('test'));
    }
