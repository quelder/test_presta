...
final class OrderQueryBuilder implements DoctrineQueryBuilderInterface
{
    ...
    public function getSearchQueryBuilder(SearchCriteriaInterface $searchCriteria)
    {
        $qb = $this
            ...
            ->addSelect('o.date_add, cu.company, a.city, o.invoice_number, o.delivery_number')
            ->addSelect($this->getDelayField() . ' AS `delay`')
        ;
    ...
    private function getBaseQueryBuilder(array $filters)
    {
        $qb = $this->connection
            ...
            ->innerJoin('o', $this->dbPrefix . 'carrier_lang', 'crl', 'o.id_carrier = crl.id_carrier and crl.id_lang = :context_lang_id')
     ...
     * @return string
     */
    private function getDelayField()
    {
        return "CONCAT_WS('<br>', crl.delay, CONCAT(a.city,'<br>', a.address1, IF(a.address2 IS NOT NULL, CONCAT(' (', a.address2, ')'), '')))";
    }
